let url = `https://newsapi.org/v2/everything?q=tech&sortBy=publishedAt&apiKey=de5ca3f710ee45f58da58be47433cba8`;

const search = () => {
    let value = document.getElementById('mySearch').value;
    url = `https://newsapi.org/v2/everything?q=${value}&sortBy=publishedAt&apiKey=de5ca3f710ee45f58da58be47433cba8`;
